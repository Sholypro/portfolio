class Perso {
	...
	deplacer(tab) {
		...
		gc.fillStyle = "grey";
		gc.fillRect(this.posX * this.persoX, this.posY * this.persoY, this.persoX, this.persoY); //afficher un carré  à l'emplacement du perso (pour effacer son ancienne position)
